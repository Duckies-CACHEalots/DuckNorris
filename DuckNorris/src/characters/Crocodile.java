...
public class Crocodile {
    ...
    public void move() {
        ...
        switch (orientation){
            ...
            case UP:
                if(!collisionDetector.isCellAvailable(headPosition, DirectionType.UP)){
            ...
            case DOWN:
                if(!collisionDetector.isCellAvailable(headPosition, DirectionType.DOWN)){
                    orientation = DirectionType.UP;
                    reverseDirection();
            ...
            case LEFT:
                if(!collisionDetector.isCellAvailable(headPosition, DirectionType.LEFT)){
            ...
            case RIGHT:
                if(!collisionDetector.isCellAvailable(headPosition, DirectionType.RIGHT)){
                    orientation = DirectionType.LEFT;
                    reverseDirection();
